...
<div class="container pb-6 pt-6">
    <div class="is-fluid mb-2">
        ...
        <h2 class="subtitle">Buscar Timbrado</h2>
    </div>
<?php 
    ...
    if(!isset($_SESSION["busqueda_timbrado"]) && empty($_SESSION["busqueda_timbrado"]) ){
...
?>
    <div class="columns">
        <div class="column">
            <form action="" method="POST" autocomplete="off" >
                <input type="hidden" name="modulo_buscador" value="timbrado">
    ...
    <div class="columns">
        <div class="column">
            <form class="has-text-centered mt-6 mb-6" action="" method="POST" autocomplete="off" >
                <input type="hidden" name="modulo_buscador" value="timbrado"> 
                <input type="hidden" name="eliminar_buscador" value="timbrado">
                <p>Estas buscando <strong>“<?php echo $_SESSION["busqueda_timbrado"];?>”</strong></p>
                <br>
    ...
    <?php
        ...
        $busqueda=$_SESSION["busqueda_timbrado"];//de categorias
