...
<div class="container pb-6 pt-6">
	...
	<form target="_blank" action="./php/reporte_ventas_realizadas.php" method="POST" autocomplete="off" enctype="multipart/form-data" >
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<span>Ventas desde</span>
