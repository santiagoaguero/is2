...
<div class="container pb-6 pt-6">
    <div class="is-fluid mb-2">
        ...
        <h2 class="subtitle">Buscar movimiento bancario</h2>
    </div>
<?php 
    ...
    if(!isset($_SESSION["busqueda_movimiento_banco"]) && empty($_SESSION["busqueda_movimiento_banco"]) ){
...
?>
    <div class="columns">
        <div class="column">
            <form action="" method="POST" autocomplete="off" >
                <input type="hidden" name="modulo_buscador" value="movimiento_banco">
    ...
    <div class="columns">
        <div class="column">
            <form class="has-text-centered mt-6 mb-6" action="" method="POST" autocomplete="off" >
                <input type="hidden" name="modulo_buscador" value="movimiento_banco"> 
                <input type="hidden" name="eliminar_buscador" value="movimiento_banco">
                <p>Estas buscando <strong>“<?php echo $_SESSION["busqueda_movimiento_banco"];?>”</strong></p>
                <br>
    ...
    <?php
        ...
        $busqueda=$_SESSION["busqueda_movimiento_banco"];//de categorias
